    ...
    >
      <div class="lg:w-1/4">
        <div class="flex flex-col pl-3">
          ...
          <router-link
            to="profile"
            class="transition-all hover:font-bold hover:text-primary px-4 py-3 border-l-2 border-primary-lighter hover:border-primary font-hk font-bold text-primary border-primary"
            >Edit Profile
          </router-link>
        </div>
        <router-link
      ...
      <div class="mt-12 lg:mt-0 lg:w-3/4">
        <div class="bg-grey-light py-10 px-6 sm:px-10">
          <h1
            class="font-hkbold mb-12 text-2xl text-secondary-100 sm:text-left"
          >
            Account Details
          </h1>
          <div class="mb-12">
        ...
        >
          <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
            <div class="">
              <label for="first_name" class="mb-2 block text-secondary-100"
                >First Name</label
              >
              <Field
                type="text"
            ...
            <div class="hidden">
              <label for="user_id" class="mb-2 block text-secondary-100"
                >First Name</label
              >
              <Field
                type="text"
            ...
            <div class="">
              <label for="last_name" class="mb-2 block text-secondary-100"
                >Last Name</label
              >
              <Field
                type="text"
