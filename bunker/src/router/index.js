...
import Shop from '@/views/store/shopView.vue'
import Login from '@/views/store/loginPage.vue'
import  AdminLogin from '@/views/admin/auth/Login.vue'
import Signup from '@/views/store/signupPage.vue'
import Product from '@/views/store/productPage.vue'
import Profile from '@/views/account/profile.vue'
import Plan from '@/views/account/plan.vue'
import OrderHistory from '@/views/account/orderHistory.vue'
import ChangePassword from '@/views/account/changePassword.vue'
import Cart from '@/views/store/cartView.vue'
import Checkout from '@/views/store/checkoutPage.vue'
