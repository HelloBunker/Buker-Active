<template>
  <div class="grid lg:grid-cols-2 container max-w-full my-2">
    ...
    <div class="container bg-gray-500 lg:shadow-2xl">
      <div class="py-0">
        <div
          class="max-w-full min-h-screen bg-gray-100 shadow-lg rounded-lg md:max-w-full"
        >
          <div class="md:flex">
            <div class="w-full">
                ...
                <div class="col-span-2 p-5">
                  ...
                  >
                    ...
                    <div class="flex justify-between space-x-2 items-center">
                      ...
                      <div class="pr-8">
                        <button
                          class="text-lg font-medium text-danger text-bold"
                  ...
                  <div
                    v-else
                    class="flex justify-center items-center py-6 px-3"
                  >
                    <span class="text-2xl font-bold tetx-center text-danger"
                      >EMPTY CART!!</span
                    >
                  </div>
                  <div
  ...
  setup() {
    ...
    const updateQuantity = (id, delta) => {
      ...
      if (item) {
        ...
        console.log(val);
        ProdService.update_cart(id, val)
          .then((response) => {
    ...
    const total = computed(() => {
      let total = 0;
      Object.values(cart.value).forEach(
