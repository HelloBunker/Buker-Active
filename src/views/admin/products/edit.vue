        ...
        <div class="mx-auto p-2">
            ...
            <div class="flex flex-wrap flex-row">
                ...
                <div class="flex-shrink max-w-full px-4 w-full">
                   <router-link to="admin_products"><button class="text-xl bg-green-500  p-4 rounded-xl text-secondary font-bold mt-3 mb-5">All Product</button></router-link>
                </div> 
                <div class="flex-shrink max-w-full px-4 w-full">
                    ...
                    <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg h-full">
                        <form class="flex flex-wrap flex-row -mx-4">
                            <div class="flex-shrink max-w-full px-4 w-full mb-4">
                                <label for="inputtitle" class="inline-block mb-2">Product Name</label>
                                <input type="text"
                            ...
                            <div class="flex-shrink max-w-full px-4 w-1/2 mb-4">
                                <label for="inputtitle" class="inline-block mb-2">Product actual price</label>
                                <input type="number"
                                    class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600"
                                    value="100"
                                    id="inputtitle">
                            ...
                            <div class="flex-shrink max-w-full px-4 w-1/2 mb-4">
                                <label for="inputtitle" class="inline-block mb-2">Product cost price</label>
                                <input type="number"
                                    class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600"
                                    value="100"
                                    id="inputtitle">
                            ...
                            <div class="flex-shrink max-w-full px-4 w-full mb-4">
                                <label for="inputdes" class="inline-block mb-2">Product description</label>
                                <textarea type="text"
                                    class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600"
                                    value="content"
                            ...
                            <div class="flex-shrink max-w-full px-4 w-full md:w-3/4 mb-4">
                                <label for="inputbudget" class="inline-block mb-2">Product Quantity</label>
                                <input type="number"
                                    class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600"
                                    value="100"
                                    id="inputbudget">
                            ...
                            <div class="flex-shrink max-w-full px-4 w-full md:w-1/4 mb-4">
                                <label for="inputtask" class="inline-block mb-2">Product Unit</label>
                                <input type="text"
                                    class="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600"
                                    value="content"
                                    id="inputtask">
                            ...
                            <div class="flex-shrink max-w-full px-4 w-full md:w-1/4 mb-4">
                                ...
                                <label for="category" class="inline-block mb-2">Product Category</label>
<select id="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
  ...
  <option value="US" selected>Sugars</option>
  ...
  <option value="DE">Germany</option>
                            ...
                            <div class="flex-shrink max-w-full px-4 w-full">
                                <button type="submit"
                                    class="py-2 px-4 block lg:inline-block text-center rounded leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0">Update
                                    Product <svg xmlns="http://www.w3.org/2000/svg" width="12" height="12"
