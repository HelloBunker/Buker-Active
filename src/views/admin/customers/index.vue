<template>
    ...
    <div class="flex justify-between items-center pb-4 bg-white dark:bg-gray-900">
        <div>
            ...
            <!-- Dropdown menu -->
            <div id="dropdownAction" class="hidden z-10 w-44 bg-primary text-secondary rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 13631px);">
        ...
        <tbody>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" class="flex items-center py-4 px-6 text-gray-900 whitespace-nowrap dark:text-white">
                    <div class="pl-3">
                        <div class="text-base text-primary font-semibold">Neil Sims</div>
                        <div class="font-normal text-gray-500">+23480237598</div>
                    </div>  
                </th>
                
                
                <td class="py-4 px-6">
                    <router-link to="#" class="font-medium  text-xl mx-3 hover:underline"><i class="bi bi-phone"></i></router-link>
                    <router-link to="#" class="font-medium text-xl mx-3 text-primary text-bold "><i class="bi bi-whatsapp"></i></router-link>
                    <router-link to="admin/customer/view" class="font-medium text-xl mx-3 text-secondary-100 "><i class="bi bi-eye"></i></router-link>
                </td>
            </tr>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                <td class="p-4 w-4">
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="py-4 px-6">
                    <router-link to="#" class="font-medium  text-xl mx-3 hover:underline"><i class="bi bi-phone"></i></router-link>
                    <router-link to="#" class="font-medium text-xl mx-3 text-primary text-bold "><i class="bi bi-whatsapp"></i></router-link>
                    <router-link to="/cutomer_view" class="font-medium text-xl mx-3 text-secondary-100 "><i class="bi bi-eye"></i></router-link>
                </td>
            </tr>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                <td class="p-4 w-4">
